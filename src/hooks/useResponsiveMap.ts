...
export const useResponsiveMap = (options: ResponsiveMapOptions = {}): UseResponsiveMapReturn => {
  ...
  const handleMobileInteraction = useCallback((event: React.TouchEvent) => {
  ...
  }, [enableMobileOptimization, mapState.touchSupported, touchZoomThreshold, doubleTapDelay, lastTouchTime])
