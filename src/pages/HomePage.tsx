...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    if (isAuthenticated && !isLoading && currentPage === 'home') {
      ...
      const shouldShow =
        !hasReallyCompleted && !userNeverWantsToSee && !isAlreadyShowing && !isCompletedThisSession;
    ...
    userPreferences?.hasCompletedTutorial,
    userPreferences?.neverShowAgain,
    startTutorial,
  ]);
  ...
  const fetchCityProperties = useCallback(
    async (city: PopularPlace) => {
    ...
    <>
      ...
      <div className="mx-auto">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          {!feedLoading && !feedError && properties.length === 0 && (
            <div className="col-span-full">
              <div className="py-12 text-center">
                ...
                <p className="mb-4 text-gray-600">{t('messages.noPropertiesInArea')}</p>
                <div className="flex justify-center gap-3">
                  <Button variant="flat" color="primary" onPress={() => getUserLocation()}>
          ...
          {hasNextPage && (
            <div ref={loadMoreRef} className="col-span-1 py-8 md:col-span-2 lg:col-span-4">
              {isLoadingMore ? (
          ...
          {!hasNextPage && properties.length > 0 && (
            <div className="col-span-1 py-8 text-center md:col-span-2 lg:col-span-4">
              <p className="text-gray-500">🎉 {t('messages.seenAllProperties')}</p>
              <Button
                variant="light"
                size="sm"
                onPress={handleRefresh}
